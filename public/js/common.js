...
// image upload Modal elemet
const pictureButton = document.querySelector(".profilePictureButton");
...
const textArea = [postTextarea, replyTextarea];
textArea
...
replyModal &&
  replyModal.addEventListener(
    "hidden.bs.modal",
    () => (originalPostContainer.innerText = "")
  );
...
function getPostIdFromElement(element) {
  ...
  const rootElement =
    element.className === "post" ? element : element.closest(".post");
